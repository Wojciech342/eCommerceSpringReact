...
public class ProductController {
    ...
    public ResponseEntity<List<ProductDTO>> updateAllProductsImage(@RequestParam("image") MultipartFile image) throws IOException {
        List<ProductDTO> updatedProductDTOs =  productService.updateAllProductsImage(image);
